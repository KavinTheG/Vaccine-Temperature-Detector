...
class Gsender
{
    ...
    private:
        ...
        const char* EMAIL_LOGIN = "gowthamangowryshankar@gmail.com"; //sender's gmail ID
        const char* EMAIL_PASSWORD = "soccer1902"; //sender's gmail account's password
        const char* FROM = "gowthamangowryshankar@gmail.com"; // sender's gmail ID
        /*------------------------------------------------------*/
