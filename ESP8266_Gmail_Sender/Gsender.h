...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "Z293dGhhbWFuZ293cnlzaGFua2FyQGdtYWlsLmNvbQ==";
        const char* EMAILBASE64_PASSWORD = "c29jY2VyMTkwMg==";
        const char* FROM = "gowthamangowryshankar@gmail.com";
