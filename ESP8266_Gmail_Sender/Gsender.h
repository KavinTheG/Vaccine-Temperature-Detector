...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "dGVzdGJvdHRvc2VuZG1haWxAZ21haWwuY29tCg==";
        const char* EMAILBASE64_PASSWORD = "VGhpc0lzVGhlUGFzc3dvcmQK";
        const char* FROM = "testbottosendmail@gmail.com";
